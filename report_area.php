...
<script type="text/javascript" src="https://www.google.com/jsapi"></script>
 ...
 ['Area', 'Patients'],
 <?php 
 $query = "SELECT count(patient_id) AS count, area.area_name as area FROM area join patients_table on patients_table.area = area.area_id GROUP BY patients_table.area ORDER BY patients_table.area";

 $exec = mysqli_query($db,$query);
 while($row = mysqli_fetch_array($exec)){

 echo "['".$row['area']."',".$row['count']."],";
 }
 ?>
