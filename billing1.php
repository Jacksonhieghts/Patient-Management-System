								...
								<div class="header_top">
									<div class="top_right">
										<ul>
											...
											<li><a href="session_log out.php">Log out</a></li>|
											<?php
    ...
    <p>
                    ...
                    $id = $row['patient_id'];
                        ...
                        ?>
                                                ...
                                                <td><center><a href="billing.php <?php echo '?id='.$id; ?>" class="btn btn-primary"><i class="glyphicon glyphicon-eye-open"></i>Bill Patient</a></center></td>
