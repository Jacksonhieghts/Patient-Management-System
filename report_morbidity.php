...
<script type="text/javascript" src="https://www.google.com/jsapi"></script>
 ...
 ['Disease', 'Patients'],
 <?php 
 $query = "SELECT count(diagnosis.patient_id) AS count, disease_name FROM disease join diagnosis on diagnosis.disease = disease.disease_id GROUP BY disease_name ORDER BY disease_name";

 $exec = mysqli_query($db,$query);
 while($row = mysqli_fetch_array($exec)){

 echo "['".$row['disease_name']."',".$row['count']."],";
 }
 ?>
